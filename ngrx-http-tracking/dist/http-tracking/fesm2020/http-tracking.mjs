...
HttpTrackingModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.1.3", ngImport: i0, type: HttpTrackingModule, imports: [CommonModule, i1.StoreFeatureModule, i1$1.EffectsFeatureModule] });
...
export { HttpTrackingFacade, HttpTrackingFacadeStub, HttpTrackingModule, createTrackingActions, createTrackingEffect };
//# sourceMappingURL=http-tracking.mjs.map
