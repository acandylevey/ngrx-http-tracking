...
export const calendarAdapter: EntityAdapter<CalendarEntity> = createEntityAdapter<CalendarEntity>({
...
const calendarReducer = createReducer(
    initialState,
    on(CalendarActions.fetchCalendars.loaded, (state, { payload }) => calendarAdapter.setAll(payload, { ...state })),
    on(CalendarActions.clearCalendars, state => calendarAdapter.removeAll(state))
);
